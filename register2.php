...
//                $_SESSION['email_verified'] = $user_data['email_verified'];
                ...
                $_SESSION['gmail'] = 0;
                $_SESSION['signup_message'] = "Usuário cadastrado gggcom sucesso!"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="register_form" action="register.php" method="post" role="form" >
                            ...
                            <div class="form-group">
                                <input type="text" name="username" id="username" tabindex="3" class="form-control" placeholder="Nome de usuário" value="<?php if(isset($username)){echo $username;}?>" required >
                                <?php
                            ...
                            <div class="form-group">
                                <input type="email" name="email" id="register_email" tabindex="4" class="form-control" placeholder="Endereço de email" value="<?php if(isset($email)){echo $email;}?>" required >
                                <?php
                            ...
                            <div class="form-group">
                                <input type="email" name="confirm_email" id="confirm_register_email" tabindex="4" class="form-control" placeholder="Confirme seu endereço de email" value="<?php if(isset($confirm_email)){echo $confirm_email;}?>" required >
                                <?php
                            ...
                            <div class="form-group">
                                <input type="password" name="password" id="password" tabindex="5" class="form-control" placeholder="Senha" value="<?php if(isset($password)){echo $password;}?>" required>
                                <?php
                            ...
                            <div class="form-group">
                                <input type="password" name="confirm_password" id="confirm_password" tabindex="6" class="form-control" placeholder="Confirme a senha" value="<?php if(isset($confirm_password)){echo $confirm_password;}?>" required>
                                <?php
